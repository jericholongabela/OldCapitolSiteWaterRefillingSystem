    ...
    <div class="h-12 bg-sky-300">
        <div class=" h-full w-full grid grid-cols-5">
            ...
            <a href="/active-order" class="my-auto mx-auto">
                <div class="flex justify-center bg-silver lg:w-56 h-8 md:w-32 w-24 rounded-md shadow-xl hover:-translate-y-0.5">
                    <p class="text-center my-auto md:text-md sm:text-s text-xs">Order to be delivered before <b>2:45 pm</b></p>
                </div>
            </a>
            <a href="#" class="my-auto mx-auto flex flex-cols-2 hover:bg-sky-500 rounded-full sm:px-2 sm:py-1 p-1 hover:border-2 border-sky-600">
